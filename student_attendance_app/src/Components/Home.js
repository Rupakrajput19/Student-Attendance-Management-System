...
export default function Home() {
  ...
  return (
    <>
      ...
      {/* <Attendance /> */}
      {/* <StudentForm /> */}
      A Student Attendance Management System is a cloud-based education ERP software that allow education
      ...
      fees, attendance, exam records and student performance and i will try add more fetaure in future...
    </>
  );
}
